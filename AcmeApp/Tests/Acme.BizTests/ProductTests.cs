...
namespace Acme.Biz.Tests
{
    ...
    public class ProductTests
    {
        ...
        {
            //Arrange
            var currentProduct = new Product(1,
                                             "Saw",
        ...
        public void ProductName_TooLong()
        {
            //Arrange
            var currentProduct = new Product();
            currentProduct.ProductName = "awawaawawaawawaawawaawawa";
            string expected = null;
            string expectedMessage = "Product Name must not be more than 20 characters long";
        ...
        [TestMethod]
        public void Category_SequenceTest()
        {
            //Arrange
            var currentProduct = new Product();
            var expected = 1;
        ...
        [TestMethod]
        public void Category_SequenceNewValue()
        {
            //Arrange
            var currentProduct = new Product();
